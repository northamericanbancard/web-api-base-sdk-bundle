            ...
            ->children()
                ->arrayNode('guzzle_configuration')
                    ...
                    ->children()
                        ...
                        ->scalarNode('allow_redirects')->defaultTrue()->end()
                        ->scalarNode('cert')->defaultNull()->end()
                        ->scalarNode('connect_timeout')->defaultValue(5.0)->end()
                        ->scalarNode('debug')->defaultFalse()->end()
                        ->scalarNode('headers')->defaultValue([])->end()
                        ->scalarNode('ssl_key')->defaultNull()->end()
                        ->scalarNode('stream')->defaultFalse()->end()
                        ->scalarNode('timeout')->defaultValue(5.0)->end()
                    ->end()
                ->end()
                ->arrayNode('endpoints')
